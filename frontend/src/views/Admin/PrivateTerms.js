...
const PrivateTerms = () => {
  ...
  const fetchtermsData = async () =>{
    const userData = await getCreatedPrivateTermsData(signer)
  ...
  const handleCreatePrivateTerm = async (e) => {
    ...
    const tx = await createTerm(termId, contractAddress, website, updatable, revocable, imgHash, signer, true, recipientAddress)
    console.log(tx) 
    if(tx.status){
      setWaitModal(false)
  ...
  return (
    <>
      ...
      {/* Page content */}
      <PrivateTermsHeader terms={termsData}/>
          ...
          <div className="col">
            <Card className="shadow" >
              <CardHeader className="border-0">
                <h3 className="mb-0">Created Private Terms</h3>
              </CardHeader>
      ...
      <Container className="mt-8" fluid>
        ...
        <Row>
          <div className="col">
            <Card className="shadow" >
              <CardHeader className="border-0">
                <h3 className="mb-0">Inbox Private Terms</h3>
              </CardHeader>
              <Table className="align-items-center table-flush" responsive>
                <thead className="thead-light">
                  <tr>
                    ...
                    <th scope="col">Revocable</th>
                    <th scope="col">Terms URL</th>
                    <th scope="col">Recipients And Status</th>
                ...
                {termsData && termsData?.inboxPrivateTerms?.map((term) =>{
                    ...
                    <td>
                        <Table>
                            <tbody className="">
                                    {Object.keys(term.recipientAndStatus).length ===0 ? <tr><td>No Other Recipients</td></tr>:
                                      Object.keys(term.recipientAndStatus).map(function (element) {
                                        return (
                                          <tr key={element}>
                                            <td>{element}</td>
                                            <td>{term.recipientAndStatus[element].statusString}</td>
                                          </tr>
                                        );
                                      })
                                    }
      ...
      <Container className="mt-7" fluid>
        <h1 className="text-center">Create a Private Term</h1>
      <Form role="form">
          ...
          <FormGroup>
            ...
            <Button type='submit' onClick={handleCreatePrivateTerm}>Create Privaseal Private Term</Button>
